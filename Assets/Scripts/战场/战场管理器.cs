...
public class 战场管理器 : MonoBehaviour
{
    ...
    {
        战场.当前剩余时间 = 战场.战场总时长; // 30分钟
        战场.倒计时进行中 = true;
        战场.是否加时阶段 = false;
        
        Debug.Log($"战场 {战场.战场ID} 开始30分钟倒计时：{战场.战场总时长}秒 ({战场.战场总时长/60}分钟)");
    ...
    private void 开始加时阶段(战场实例 战场)
    {
        ...
        Debug.Log($"双方积分相同，进入加时阶段：{战场.加时时长}秒 ({战场.加时时长/60}分钟)");
        通用提示框.显示($"双方积分相同！进入{战场.加时时长/60}分钟加时赛！");
